...
/**
 * @fn comb_align_calc_gapless_thresh
 */
static _force_inline
int64_t comb_align_calc_gapless_thresh(
	struct comb_align_params_s const *params)
{
...
/**
 * @fn comb_align_calc_xdrop_thresh
 */
static _force_inline
int64_t comb_align_calc_xdrop_thresh(
	struct comb_align_params_s const *params)
{
...
/**
 * @fn comb_align_calc_score_thresh
 */
static _force_inline
int64_t comb_align_calc_score_thresh(
	struct comb_align_params_s const *params)
{
	return(100 * params->m);
}
...
/**
 * @fn comb_align_parse_args
 */
static
struct comb_align_params_s *comb_align_parse_args(
	char const *base,
	int argc,
	char *argv[])
{
	...
	*params = (struct comb_align_params_s){
	...
	if(params->gapless_thresh == 0) {
		params->gapless_thresh = comb_align_calc_gapless_thresh(params);
	}
	if(params->xdrop == 0) {
		params->xdrop = comb_align_calc_xdrop_thresh(params);
	}
	if(params->score_thresh == 0) {
		params->score_thresh = comb_align_calc_score_thresh(params);
	}
...
/**
 * @fn comb_align_clean_params
 */
static _force_inline
void comb_align_clean_params(
...
/**
 * @fn comb_index_parse_args
 */
static
struct comb_index_params_s *comb_index_parse_args(
	char const *base,
	int argc,
	char *argv[])
{
...
/**
 * @fn comb_index_clean_params
 */
static _force_inline
void comb_index_clean_params(
	...
	char *argv[])
{
	...
	if(strcmp(argv[1], "index") == 0) {
		*o = (struct comb_inst_s){
			.params = (void *)comb_index_parse_args(base, argc - 1, argv + 1),
			.print = (void (*)(void *))comb_index_print_option_summary,
			.process = (int (*)(void *))comb_index,
			.clean = (void (*)(void *))comb_index_clean_params
		};
		...
		*o = (struct comb_inst_s){
			.params = (void *)comb_align_parse_args(base, argc, argv),
			.print = (void (*)(void *))comb_align_print_option_summary,
			.process = (int (*)(void *))comb_align,
			.clean = (void (*)(void *))comb_align_clean_params
		};
	}
	return(o);
}
...
int main(int argc, char *argv[])
{
	...
	if(o == NULL) {
		comb_print_error("subcommand %s is not implemented.", argv[1]);
		return(1);
	}
